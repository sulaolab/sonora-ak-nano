    ...
    const dspic33ak_clock_reg_clkgen_config_t *config)
{
    ...
    /* CLKGEN1 is changed through the live-system switch path. The resident
     * only owns peripheral CLKGEN6 (Timer1) and CLKGEN8 (UART1). */
    ...
    const dspic33ak_clock_reg_pll_config_t *config)
{
     ...
     * depended on it. See recorded validation.

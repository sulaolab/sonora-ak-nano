/*
 * wm8904_def.h -- WM8904 register map for this board.
 *
 * Register NAMES and ADDRESSES follow the WM8904 datasheet's own register table
 * (Cirrus Logic / Wolfson Microelectronics), and the bit definitions are that
 * table's fields. Any other WM8904 header will use much the same names for the
 * same reason -- they are the part's names, not an invention of either file.
 *
 * DEFINITIONS ONLY. No I2C, no register sequencing, no driver state: what touches
 * the part is board/devices/wm8904.c, driven through the I2C HAL. So a name
 * appearing here is not evidence that anything writes it -- most of this table is
 * unused, kept because the next bring-up question is usually about a register the
 * driver has never needed.
 *
 * The doxygen block that stood here until 2026-08-14 described a SAM/TWI driver
 * and a "quickstart" page, neither of which exists in this tree; it was removed as
 * incorrect rather than edited.
 */

#ifndef _WM8904_REG_DEF_H
#define	_WM8904_REG_DEF_H
...
/*
 * R0 (0x00) - SW Reset and ID / WM8904_SW_RESET_AND_ID
 */
#define WM8904_SW_RST_DEV_ID1_Pos               0  /* SW_RST_DEV_ID1 - [15:0] */
#define WM8904_SW_RST_DEV_ID1                   0x8904

/*
 * R4 (0x04) - Bias Control 0 / WM8904_BIAS_CONTROL_0
 */
...
/*
 * R5 (0x05) - VMID Control 0 / WM8904_VMID_CONTROL_0
 */
...
/*
 * R6 (0x06) - Mic Bias Control 0 / WM8904_MIC_BIAS_CONTROL_0
 */
...
/*
 * R9 (0x07) - Mic Bias Control 1 / WM8904_MIC_BIAS_CONTROL_1
 */
...
/*
 * R10 (0x0A) - Analogue ADC 0 / WM8904_ANALOGUE_ADC_0
 */
#define WM8904_ADC_OSR128_Pos                   0  /* ADC_OSR128 */
#define WM8904_ADC_OSR128                       0x0001

/*
 * R12 (0x0C) - Power Management 0 / WM8904_POWER_MANAGEMENT_0
 */
...
/*
 * R14 (0x0E) - Power Management 2 / WM8904_POWER_MANAGEMENT_2
 */
...
/*
 * R15 (0x0F) - Power Management 3 / WM8904_POWER_MANAGEMENT_3
 */
...
/*
 * R18 (0x12) - Power Management 6 / WM8904_POWER_MANAGEMENT_6
 */
...
/*
 * R20 (0x14) - Clock Rates 0 / WM8904_CLOCK_RATES_0
 */
...
/*
 * R21 (0x15) - Clock Rates 1 / WM8904_CLOCK_RATES_1
 */
...
/*
 * R22 (0x16) - Clock Rates 2 / WM8904_CLOCK_RATES_2
 */
...
/*
 * R24 (0x18) - Audio Interface 0 / WM8904_AUDIO_INTERFACE_0
 */
...
/*
 * R25 (0x19) - Audio Interface 1 / WM8904_AUDIO_INTERFACE_1
 */
...
/*
 * R26 (0x1A) - Audio Interface 2 / WM8904_AUDIO_INTERFACE_2
 */
...
/*
 * R27 (0x1B) - Audio Interface 3 / WM8904_AUDIO_INTERFACE_3
 */
...
/*
 * R30 (0x1E) - DAC Digital Volume Left / WM8904_DAC_DIGITAL_VOLUME_LEFT
 */
...
/*
 * R31 (0x1F) - DAC Digital Volume Right / WM8904_DAC_DIGITAL_VOLUME_RIGHT
 */
#define WM8904_DAC_VU_Pos                       8  /* DAC_VU */
#define WM8904_DAC_VU                           0x0100
...
/*
 * R32 (0x20) - DAC Digital 0 / WM8904_DAC_DIGITAL_0
 */
...
/*
 * R33 (0x21) - DAC Digital 1 / WM8904_DAC_DIGITAL_1
 */
...
/*
 * R36 (0x24) - ADC Digital Volume Left / WM8904_ADC_DIGITAL_VOLUME_LEFT
 */
...
/*
 * R37 (0x25) - ADC Digital Volume Right / WM8904_ADC_DIGITAL_VOLUME_RIGHT
 */
#define WM8904_ADC_VU_Pos                       8  /* ADC_VU */
#define WM8904_ADC_VU                           0x0100
...
/*
 * R38 (0x26) - ADC Digital 0 / WM8904_ADC_DIGITAL_0
 */
...
/*
 * R39 (0x27) - Digital Microphone 0 / WM8904_DIGITAL_MICROPHONE_0
 */
...
/*
 * R44 (0x2C) - Analogue Left Input 0 / WM8904_ANALOGUE_LEFT_INPUT_0
 */
...
/*
 * R45 (0x2D) - Analogue Right Input 0 / WM8904_ANALOGUE_RIGHT_INPUT_0
 */
...
/*
 * R46 (0x2E) - Analogue Left Input 1 / WM8904_ANALOGUE_LEFT_INPUT_1
 */
...
/*
 * R47 (0x2F) - Analogue Right Input 1 / WM8904_ANALOGUE_RIGHT_INPUT_1
 */
...
#define WM8904_R_IP_SEL_N_IN1R                  WM8904_R_IP_SEL_N(0)
#define WM8904_R_IP_SEL_N_IN2R                  WM8904_R_IP_SEL_N(1)
#define WM8904_R_IP_SEL_N_IN3R                  WM8904_R_IP_SEL_N(2)
...
#define WM8904_R_IP_SEL_P_IN1R                  WM8904_R_IP_SEL_P(0)
#define WM8904_R_IP_SEL_P_IN2R                  WM8904_R_IP_SEL_P(1)
#define WM8904_R_IP_SEL_P_IN3R                  WM8904_R_IP_SEL_P(2)
...
/*
 * R57 (0x39) - Analogue OUT1 Left / WM8904_ANALOGUE_OUT1_LEFT
 */
...
/*
 * R58 (0x3A) - Analogue OUT1 Right / WM8904_ANALOGUE_OUT1_RIGHT
 */
...
/*
 * R59 (0x3B) - Analogue OUT2 Left / WM8904_ANALOGUE_OUT2_LEFT
 */
...
/*
 * R60 (0x3C) - Analogue OUT2 Right / WM8904_ANALOGUE_OUT2_RIGHT
 */
...
/*
 * R61 (0x3D) - Analogue OUT12 ZC / WM8904_ANALOGUE_OUT12_ZC
 */
...
/*
 * R67 (0x43) - DC Servo 0 / WM8904_DC_SERVO_0
 */
...
/*
 * R68 (0x44) - DC Servo 1 / WM8904_DC_SERVO_1
 */
...
/*
 * R69 (0x45) - DC Servo 2 / WM8904_DC_SERVO_2
 */
...
/*
 * R71 (0x47) - DC Servo 4 / WM8904_DC_SERVO_4
 */
...
/*
 * R72 (0x48) - DC Servo 5 / WM8904_DC_SERVO_5
 */
...
/*
 * R73 (0x49) - DC Servo 6 / WM8904_DC_SERVO_6
 */
...
/*
 * R74 (0x4A) - DC Servo 7 / WM8904_DC_SERVO_7
 */
...
/*
 * R75 (0x4B) - DC Servo 8 / WM8904_DC_SERVO_8
 */
...
/*
 * R76 (0x4C) - DC Servo 9 / WM8904_DC_SERVO_9
 */
...
/*
 * R77 (0x4D) - DC Servo Readback 0 / WM8904_DC_SERVO_READBACK_0
 */
...
/*
 * R90 (0x5A) - Analogue HP 0 / WM8904_ANALOGUE_HP_0
 */
...
/*
 * R94 (0x5E) - Analogue Lineout 0 / WM8904_ANALOGUE_LINEOUT_0
 */
...
/*
 * R109 (0x6D) - Write Sequencer 1 / WM8904_WRITE_SEQUENCER_1
 */
...
/*
 * R110 (0x6E) - Write Sequencer 2 / WM8904_WRITE_SEQUENCER_2
 */
...
/*
 * R111 (0x6F) - Write Sequencer 3 / WM8904_WRITE_SEQUENCER_3
 */
...
/*
 * R112 (0x70) - Write Sequencer 4 / WM8904_WRITE_SEQUENCER_4
 */
...
/*
 * R116 (0x74) - FLL Control 1 / WM8904_FLL_CONTROL_1
 */
...
/*
 * R117 (0x75) - FLL Control 2 / WM8904_FLL_CONTROL_2
 */
...
/*
 * R118 (0x76) - FLL Control 3 / WM8904_FLL_CONTROL_3
 */
...
/*
 * R119 (0x77) - FLL Control 4 / WM8904_FLL_CONTROL_4
 */
...
/*
 * R120 (0x78) - FLL Control 5 / WM8904_FLL_CONTROL_5
 */
...
/*
 * R121 (0x79) - GPIO Control 1 / WM8904_GPIO_CONTROL_1
 */
...
/*
 * R122 (0x7A) - GPIO Control 2 / WM8904_GPIO_CONTROL_2
 */
...
/*
 * R123 (0x7B) - GPIO Control 3 / WM8904_GPIO_CONTROL_3
 */
...
/*
 * R124 (0x7C) - GPIO Control 4 / WM8904_GPIO_CONTROL_4
 */
...
/*
 * R126 (0x7E) - Digital Pulls / WM8904_DIGITAL_PULLS
 */
...
/*
 * R127 (0x7F) - Interrupt Status / WM8904_INTERRUPT_STATUS
 */
...
/*
 * R128 (0x80) - Interrupt Status Mask / WM8904_INTERRUPT_STATUS_MASK
 */
...
/*
 * R129 (0x81) - Interrupt Polarity / WM8904_INTERRUPT_POLARITY
 */
...
/*
 * R130 (0x82) - Interrupt Debounce / WM8904_INTERRUPT_DEBOUNCE
 */
...
/*
 * R198 (0xC6) - ADC Test 0 / WM8904_ADC_TEST_0
 */
...
/*
 * R247 (0xF7) - FLL NCO Test 0 / WM8904_FLL_NCO_TEST_0
 */
#define WM8904_FLL_FRC_NCO_Pos                  0  /* FLL_FRC_NCO */
#define WM8904_FLL_FRC_NCO                      0x0001

/*
 * R248 (0xF8) - FLL NCO Test 1 / WM8904_FLL_NCO_TEST_1
 */
